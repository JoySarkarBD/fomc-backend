 ...
 * This interface includes properties such as id, name, email, role, and department, which represent the essential information about the authenticated user that may be needed for authorization and business logic within the controllers and services of the API Gateway.
